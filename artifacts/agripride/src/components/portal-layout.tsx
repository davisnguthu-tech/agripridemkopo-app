...
import { Sprout, LayoutDashboard, FileText, User, LogOut, Menu, Brain, Info } from "lucide-react";
...
const navItems = [
  ...
  { href: "/portal/coach", label: "Financial Coach", icon: Brain, badge: "AI" },
  ...
  return (
    <div className="flex min-h-screen w-full bg-background">
      ...
      <aside className="hidden md:flex w-64 flex-col border-r border-sidebar-border bg-sidebar text-sidebar-foreground flex-shrink-0">
        <div className="flex h-16 items-center border-b border-sidebar-border px-5 gap-2">
          <div className="bg-primary text-primary-foreground rounded-lg p-1.5">
            <Sprout className="h-4 w-4" />
          </div>
          <div>
            <p className="font-bold tracking-tight text-sm leading-none">AgriPride</p>
            <p className="text-[10px] text-sidebar-foreground/50 mt-0.5">Mkopo Portal</p>
          </div>
        </div>
        ...
        <div className="p-3 border-t border-sidebar-border">
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] text-sidebar-foreground/50 mt-0.5">Applicant</p>
            </div>
            <Tooltip>
      ...
      <div className="flex flex-col flex-1 min-w-0">
        <header className="flex h-14 items-center gap-3 border-b bg-card px-4 shadow-sm z-10 sticky top-0">
          <Sheet>
            ...
            <SheetContent side="left" className="w-64 bg-sidebar text-sidebar-foreground p-0 border-r-0">
              ...
              <div className="flex h-14 items-center border-b border-sidebar-border px-5 gap-2">
                <div className="bg-primary text-primary-foreground rounded-lg p-1.5">
                  <Sprout className="h-4 w-4" />
                </div>
                <span className="font-bold tracking-tight text-sm">AgriPride Mkopo</span>
              </div>
          ...
          <div className="flex items-center gap-2 md:hidden">
            ...
            <span className="font-bold text-sm">AgriPride</span>
          </div>
